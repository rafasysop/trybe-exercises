...
valores, calcule quanto de lucro (valor de venda descontado o custo do produto) 
...
O lucro de um produto é o resultado da subtração do valor de venda pelo 
custo do mesmo, sendo que o imposto de 20% também faz parte do valor de custo.
...
let lucro = (b * 1000) - ( a*1000 +((a*1000)*20/100))
